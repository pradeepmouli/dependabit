...
## `AuthConfigSchema`
```ts
const AuthConfigSchema: ZodOptional<ZodObject<{ type: ZodEnum<{ token: "token"; basic: "basic"; oauth: "oauth"; none: "none" }>; secretEnvVar: ZodOptional<ZodString> }, $strip>>
```
