...
[Documentation](../../README.md) / @dependabit/github-client
...
- [BasicAuthHandler](classes/BasicAuthHandler.md)
- [FeedbackListener](classes/FeedbackListener.md)
- [GitHubClient](classes/GitHubClient.md)
- [IssueManager](classes/IssueManager.md)
- [OAuthHandler](classes/OAuthHandler.md)
- [RateLimitHandler](classes/RateLimitHandler.md)
- [ReleaseManager](classes/ReleaseManager.md)
- [TokenAuthHandler](classes/TokenAuthHandler.md)

## Interfaces

- [AuthConfig](interfaces/AuthConfig.md)
- [BasicAuth](interfaces/BasicAuth.md)
- [BudgetReservation](interfaces/BudgetReservation.md)
- [CommitDiff](interfaces/CommitDiff.md)
- [CommitFile](interfaces/CommitFile.md)
- [CommitInfo](interfaces/CommitInfo.md)
- [FeedbackConfig](interfaces/FeedbackConfig.md)
- [FeedbackData](interfaces/FeedbackData.md)
- [FeedbackRate](interfaces/FeedbackRate.md)
...
- [OAuthAuth](interfaces/OAuthAuth.md)
- [OAuthConfig](interfaces/OAuthConfig.md)
- [ParsedFiles](interfaces/ParsedFiles.md)
...
- [createGitHubClient](functions/createGitHubClient.md)
- [fetchCommits](functions/fetchCommits.md)
- [getCommitDiff](functions/getCommitDiff.md)
- [getCommitsBetween](functions/getCommitsBetween.md)
- [parseCommitFiles](functions/parseCommitFiles.md)
